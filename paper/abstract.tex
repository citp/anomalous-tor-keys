...
%
Our experiments revealed that ten relays shared moduli, and 3,557 relays---most 
of which belonged to a research project---shared prime factors, allowing adversaries to
...
we identified four onion services that were likely targeted by these
malicious relays.
\end{abstract}
