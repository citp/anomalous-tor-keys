...
relays\footnote{This information includes IP addresses, ports, version numbers, and
...
\emph{descriptor}, which contains additional relay-specific information such as
cryptographic keys.
