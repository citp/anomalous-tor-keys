...
fingerprint in ascending order, the three immediate HSDir neighbors in positive
...
service's descriptor ID, and hence its two replicas changes each day when
