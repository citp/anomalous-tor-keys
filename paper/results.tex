...
\emph{modulus}, giving them the ability to calculate each other's private 
keys.
%meaning that they were able to calculate each other's private
%key.  
Table~\ref{tab:moduli} illustrates these ten relays, clustered into four
